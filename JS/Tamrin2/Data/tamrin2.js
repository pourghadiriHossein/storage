...
box.addEventListener("mousemove", updateCoordinate, false);
box.addEventListener("mouseenter", updateCoordinate, false);
box.addEventListener("mouseleave", updateCoordinate, false);
